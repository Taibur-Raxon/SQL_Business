...
-- selected these tech categories 
-- 1. Audio
...
where pct.product_category_name_english in ('audio', 'consoles_games', 'electronics', 'pc_gamer', 'computers', 
    'tablets_printing_image', 'computers_accessories', 'small_appliances', 'watches_gifts', 'telephony');
-- answer total_revenue '3213237.06'',total_shipping_cost '415819.93'',avg_review_score ''3.97''.

### total and tech products
select 
    count(distinct oi.product_id) as total_products,
    (select count(distinct oi_sub.product_id)
     ...
     where pct_sub.product_category_name_english in (
         'audio','consoles_games','electronics','pc_gamer','computers',
'tablets_printing_image','computers_accessories','small_appliances','watches_gifts','telephony'
     )) as total_tech_products
from order_items oi;